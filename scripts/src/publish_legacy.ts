...
const path_to_contracts = path.join(path_to_scripts, "../../contracts/Legacy/sources")
...
writeFileSync(path.join(path_to_scripts, "../deployed_legacy_objects.json"), JSON.stringify(deployed_address, null, 4))
